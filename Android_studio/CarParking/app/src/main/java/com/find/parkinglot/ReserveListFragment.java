...
//                        deleteRef5.removeValue();
                ...
                Toast t = Toast.makeText(getActivity(), "Thank you for paying with Viettel Pay", Toast.LENGTH_LONG);
...
//                        deleteRef5.removeValue();
                ...
                Toast t = Toast.makeText(getActivity(), "Thank you for paying with Shopee Pay", Toast.LENGTH_LONG);
                t.setGravity(Gravity.CENTER, 0, 0);
                t.show();
            }
        });
